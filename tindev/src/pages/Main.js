...
export default function Main ({ navigation }){
    ...
    return (
        ...
        { users.length === 0
            ? <Text style={styles.empty}>Acabouu :(</Text>
            : (
            ...
            { users.length > 0 && (
                <View style={styles.buttonsContainer}>
                    <TouchableOpacity style={styles.button}>
                        <Image style={styles.like} source={like} onPress={handleDislike}/>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.button}>
                        <Image style={styles.dislike} source={dislike} onPress={handleLike}/>
                    </TouchableOpacity>
                </View>
            )}
